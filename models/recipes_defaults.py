...
default_ingredients = [
    ...
    Ingredients(id=6, name=''),
    Ingredients(id=7, name=''),
    Ingredients(id=8, name=''),
    Ingredients(id=9, name=''),
    Ingredients(id=10, name=''),
    Ingredients(id=12, name=''),
    Ingredients(id=13, name=''),
    Ingredients(id=14, name=''),
    Ingredients(id=16, name=''),
    Ingredients(id=17, name=''),
    Ingredients(id=18, name=''),
    Ingredients(id=19, name=''),
]